...
import classes from "./RevokeAccessMember.module.css";
const RevokeAccessMember = () =>  {
    return (
        <>
            <StyledEngineProvider injectFirst>
                <Box
                    component="RevokeAccessMember"
                    ...
                    <CardContent className={classes.titleStyle}>
                        ...
                        <Stack className={classes.inpf}>
                            ...
                            <Stack gap={'10px'} className={classes.inpy}>
                                Access Level: 
                                <span className={classes.op1}> Team Member</span>
                            </Stack>
...
export default RevokeAccessMember;